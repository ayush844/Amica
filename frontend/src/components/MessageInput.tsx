  ...
  return (
    <form className=' flex flex-col gap-2 border-t border-gray-700 pt-2' onSubmit={handleSubmit}>
        ...
        <div className="flex items-center gap-2">
            ...
            <input type="text" className=' flex-1 bg-gray-700 px-4 py-2 text-white placeholder-gray-400' placeholder={imageFile ? "Add a caption..." : "Type a Message..."} value={message} onChange={(e)=> setMessage(e.target.value)} />
